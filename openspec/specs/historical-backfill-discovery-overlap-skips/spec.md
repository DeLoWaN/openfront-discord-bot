# historical-backfill-discovery-overlap-skips Specification

## Purpose

Track known readable history that ordinary discovery excludes before hydration
work is queued so operators can distinguish overlap avoided during discovery
from hydration compatibility skips.
